...
<style>
    ...
    .parallax-section {
      background-image: url('<?php echo base_url("myesc.id/assets/gambar/kedukaan2.jpg"); ?>');
      height: 85vh;
      background-position: center;
      background-repeat: no-repeat;
      background-size: cover;
...
<body>
 ...
 <!-- Konten -->
     ...
     <div class="section light dedication">
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/ynduZfofcfI?si=NpBjOqTek1TB5JTP" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </div>
