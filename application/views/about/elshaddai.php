...
<style>
       @import url('https://fonts.googleapis.com/css2?family=Figtree:wght@400;500;600;700&display=swap');
        ...
        .rediscover-section {
          ...
          background-image: url('<?php echo base_url("assets/gambar/jesus.jpg"); ?>');
          color: white;
          text-align: center;
          padding: 215px 20px;
        }
...
<body>
    ...
    <section class="rediscover-section">
      <div class="content">
        <h1 style="font-size: 3.2rem; margin-bottom: 20px; color: #ffffff; font-weight: bold;">Our Owner</h1>
        ...
        <div class="slideshow-container">
          ...
          <div class="slide active">
            <video autoplay muted loop playsinline class="slide-video">
              ...
              <source src="<?php echo base_url('assets/gambar/aniv.mp4'); ?>" type="video/mp4">
  ...
  <!-- Nilai-Nilai -->
    ...
    <section class="section fade-in values-section">
        ...
        <div class="value-accordion">
          ...
          <div class="value-panel active" style="background-image: url('');">
          ...
          <div class="value-panel" style="background-image: url('img/obedience.jpg');">
          ...
          <div class="value-panel" style="background-image: url('img/relevant.jpg');">
          ...
          <div class="value-panel" style="background-image: url('img/discipleship.jpg');">
    ...
    <section style="padding: 40px 20px; background-color: #fafafa;">
        ...
        <div style="display: flex; flex-direction: column; gap: 30px; align-items: center;">
          ...
          <!-- Pastor 1 -->
          <div 
            style="display: flex; cursor: pointer; background: white; border-radius: 16px; overflow: hidden; box-shadow: 0 8px 16px rgba(0,0,0,0.1); max-width: 1000px; width: 100%; transition: transform 0.3s;"
            onmouseover="this.style.transform='scale(1.02)'" onmouseout="this.style.transform='scale(1)'">
            
            <!-- Gambar -->
            <div style="flex: 1 1 400px; min-width: 130px;">
              <img src="<?php echo base_url('assets/gambar/gembala.jpg'); ?>" alt="Deskripsi gambar"
                  style="width: 100%; height: 100%; object-fit: cover;">
            </div>

            <!-- Konten Info -->
            <div style="flex: 1 1 700px; padding: 30px; background: #fafafa; display: flex; flex-direction: column; justify-content: center;">
              <h3 style="font-size: 15px; margin-bottom: 10px;">Ps. Yehezkiel Wilan & Ps. Sandra Nappoe</h3>
              
              <!-- Kutipan -->
              <blockquote style="font-style: italic; font-size: 15px; line-height: 1.5; color: #444; margin: 10px 0;">
                Senior Pastor.
              </blockquote>
              <!--<p style="font-size: 18px; line-height: 1.5; color: #444; margin: 10px 0;">-->
          ...
          <!-- <div 
               ...
               onmouseover="this.style.transform='scale(1.02)'" onmouseout="this.style.transform='scale(1)'">
            <div style="flex: 1 1 400px; min-width: 130px;">
              <img src="assets/gambar/ps.sandra.jpg" alt="Ps. Sandra"
                   style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div style="flex: 1 1 700px; padding: 30px; background: #fafafa;">
              <h3 style="font-size: 24px; margin-bottom: 10px;">Ps. Sandra</h3>
              <p style="font-size: 16px; color: #555;">Gembala Sidang</p>
            </div>
          </div> -->
          ...
          <div 
            ...
            <!-- Gambar -->
            <div style="flex: 1 1 400px; min-width: 130px;">
              <img src="<?php echo base_url('assets/gambar/GH_David & Istri.jpg'); ?>" alt="Deskripsi gambar"
                  style="width: 100%; height: 100%; object-fit: cover;">
            </div>

            <!-- Konten Info -->
            <div style="flex: 1 1 700px; padding: 30px; background: #fafafa; display: flex; flex-direction: column; justify-content: center;">
              <h3 style="font-size: 15px; margin-bottom: 10px;">Ps. David Ryan Wilando & Nindya Elysa</h3>
          ...
          <div 
            ...
            <!-- Gambar -->
            <div style="flex: 1 1 400px; min-width: 130px;">
              <img src="<?php echo base_url('assets/gambar/GH_thian & istri.jpg'); ?>" alt="Deskripsi gambar"
                  style="width: 100%; height: 100%; object-fit: cover;">
            </div>

            <!-- Konten Info -->
            <div style="flex: 1 1 700px; padding: 30px; background: #fafafa; display: flex; flex-direction: column; justify-content: center;">
              <h3 style="font-size: 15px; margin-bottom: 10px;">Ps. Jozethian Watta & Dona Dorina</h3>
          ...
          <div 
            ...
            <!-- Gambar -->
            <div style="flex: 1 1 400px; min-width: 130px;">
              <img src="<?php echo base_url('assets/gambar/GH_Lampos & Istri.jpg'); ?>" alt="Deskripsi gambar"
                  style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            ...
            <div style="flex: 1 1 700px; padding: 30px; background: #fafafa; display: flex; flex-direction: column; justify-content: center;">
              <h3 style="font-size: 15px; margin-bottom: 10px;">
                Ps. Lampos Rajagukguk & Shangrila Djehadut</h3>
              
              <!-- Kutipan -->
              <blockquote style="font-style: italic; font-size: 15px; line-height: 1.5; color: #444; margin: 10px 0;">
                Group Head Community.
              </blockquote>
            </div>
          </div>
          ...
          <div 
            ...
            <!-- Gambar -->
            <div style="flex: 1 1 400px; min-width: 130px;">
              <img src="<?php echo base_url('assets/gambar/GH_Johanes & Istri.jpg'); ?>" alt="Deskripsi gambar"
                  style="width: 100%; height: 100%; object-fit: cover;">
            </div>

            <!-- Konten Info -->
            <div style="flex: 1 1 700px; padding: 30px; background: #fafafa; display: flex; flex-direction: column; justify-content: center;">
              <h3 style="font-size: 15px; margin-bottom: 10px;">Ps. johannes Johari & Erni Suryadi</h3>
          ...
          <div 
            ...
            <!-- Gambar -->
            <div style="flex: 1 1 400px; min-width: 130px;">
              <img src="assets/gambar/" alt="Ps. Rivan"
                  style="width: 100%; height: 100%; object-fit: cover;">
            </div>

            <!-- Konten Info -->
            <div style="flex: 1 1 700px; padding: 30px; background: #fafafa; display: flex; flex-direction: column; justify-content: center;">
              <h3 style="font-size: 15px; margin-bottom: 10px;">Ps. Stevanus Rivan Tampi & Istri</h3>
              
              <!-- Kutipan -->
              <blockquote style="font-style: italic; font-size: 15px; line-height: 1.5; color: #444; margin: 10px 0;">
                Group Head Next Step.
              </blockquote>
            </div>
          </div>
          ...
          <div 
            ...
            <!-- Gambar -->
            <div style="flex: 1 1 400px; min-width: 130px;">
              <img src="assets/gambar/" alt="Eiva Rade Sitio"
                  style="width: 100%; height: 100%; object-fit: cover;">
            </div>

            <!-- Konten Info -->
            <div style="flex: 1 1 700px; padding: 30px; background: #fafafa; display: flex; flex-direction: column; justify-content: center;">
              <h3 style="font-size: 15px; margin-bottom: 10px;">Eiva Rade Sitio</h3>
