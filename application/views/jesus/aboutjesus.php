...
<style>
    ...
    .hero-section {
        ...
        background: url('<?php echo base_url("assets/gambar/jesus2.jpg"); ?>')no-repeat center center/cover;
        color: white;
        text-align: center;
        padding: 380px 20px;
    }
    ...
    .parallax-section {
    background-image: url('assets/gambar/paralaxjesus.jpg');
    ...
    @media (max-width: 768px) {
        .parallax-section {
        background: url('<?php echo base_url("assets/gambar/paralaxjesus.jpg"); ?>')no-repeat center center/cover;
