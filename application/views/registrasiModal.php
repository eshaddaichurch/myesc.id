...
.mobile-app .header-gradient h3::after {
  ...
  body.mobile-app #smartwizard {
    height: calc(100vh - 120px); /* Kurangi tinggi toolbar & header */
    display: flex;
  ...
  body.mobile-app .btnSelesai {
    ...
    font-size: 18px;
    padding: 16px;
    box-shadow: 0 8px 20px rgba(255,129,0,0.35);
    width: 100%;
    max-width: 100%;
  }

  /* Hover & Active State */
  body.mobile-app .sw-btn-next:hover,
  body.mobile-app .btnSelesai:hover {
    transform: translateY(-1px);
    box-shadow: 0 6px 24px rgba(255,129,0,0.4);
  }

  body.mobile-app .sw-btn-prev:hover {
    background: #e5e9ec;
    border-color: #d1d5db;
  }
  ...
  body.mobile-app .btn-secondary:hover {
    background: #f3f4f6;
    border-color: #d1d5db;
  }
  ...
  .mobile-app .modal-body > .row > .col-12:first-child h3::after {
    content: "Buat akun dan lengkapi data Anda";
    display: block;
    font-size: 14px;
    font-weight: 400;
  ...
  .mobile-app .form-check-label a:hover {
    color: #ff5008;
  }
      ...
      <div class="modal-body modal-custom">
        ...
        <div class="col-12 header-gradient">
          ...
          <div class="col-12 p-3">
            ...
            <!-- Tombol Batal (hanya untuk mobile) -->
            <div class="text-end mt-3">
              <button class="btn btn-secondary btn-batal-mobile" onclick="onCancel()" style="position: fixed; bottom: 20px; right: 20px; z-index: 1000; padding: 8px 16px; font-size: 14px;">Batal</button>
            </div>
