    ...
    <body>
      ...
      <section class="section-container" id="small-groups" data-aos="fade-up">
        <div class="section-text">
          <h1 style="color: #ffffff;">YOUTH</h1>
      ...
      <a href="#" class="btn" style="background-color: #000000;">
        ...
        <div class="section-image">
          <!--<img src="assets/gambar/youth1.jpg" alt="Small Groups">-->
          <img src="<?php echo base_url('myesc.id/assets/gambar/youth1.jpg'); ?>" alt="Small Groups">
        </div>
      </section>
        ...
        <div class="info">
          <div class="meeting-times">
            ...
            <div class="meeting-block">
              <p><strong>Youth | Minggu Pagi</strong></p>
              <!-- <p>Pre-Service Hangs @ 6:00pm</p> -->
              <p>10:30 Pagi - 12:00 Siang</p>
            </div>

            <div class="meeting-block">
              <!-- <p><strong>High School | Wednesdays</strong></p>
              <p>Pre-Service Hangs @ 7:15pm</p>
              <p>Service @ 7:45pm</p> -->
            </div>

            <h2>Lokasi</h2>
            <p><strong>Gereja GBI El Shaddai</strong></p>
            <p>Ruangan Serba Guna Lantai 2</p>
          </div>

          <div class="about">
            <h1>ESC Youth</h1>
            <p>
              ESC Youth adalah komunitas bagi remaja SMP hingga SMA yang dibentuk untuk menjadi generasi yang beriman kepada Tuhan, bernilai Kristus, dan berdampak bagi generasinya. Masa remaja bukan masa tunggu, tapi masa bertumbuh untuk membangun karakter, membentuk iman yang kuat, dan mulai berdampak secara nyata di keluarga, sekolah, dan komunitas mereka. Bersama El Shaddai Church, kami memperlengkapi generasi ini untuk menjadi pribadi yang tidak hanya dibentuk, tapi juga untuk membuat perbedaan.
            </p>
          </div>
        </div>
      </section>
