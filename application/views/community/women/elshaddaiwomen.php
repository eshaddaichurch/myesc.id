    ...
    <body>
      ...
      <section class="section-container" id="small-groups" data-aos="fade-up">
        <div class="section-text">
          <h1 style="color: #ffffff;">ESC WOMEN</h1>
      ...
      <a href="#" class="btn" style="background-color: #000000;">
        ...
        <div class="section-image">
          <img src="<?php echo base_url('myesc.id/assets/gambar/women.JPG') ?>" alt="Small Groups">
        </div>
      </section>
      ...
      <div class="section light dedication">
        ...
        <div class="dedication-text">
          <br>
          <p class="responsive-text" style="text-align: center;">
      ...
      <section class="young-esc">
        <div class="info">
          ...
          <div class="about">
            <h1 style="color: #ffffff;">ESC Women</h1>
            <p style="color: #ffffff;">
              ESC Women adalah komunitas bagi para wanita dari berbagai musim kehidupan yang rindu bertumbuh dalam karakter Kristus, menemukan dan mengembangkan potensi dirinya, serta menjadi pribadi yang berdampak di keluarga, gereja, dan masyarakat. Kita percaya bahwa setiap wanita memiliki panggilan unik dalam Kerajaan Allah, dan komunitas ini hadir untuk memperlengkapi, menguatkan, dan menginspirasi mereka agar dapat berjalan sesuai dengan tujuan ilahi dalam hidup mereka. Bersama dalam semangat, kita membangun generasi wanita yang tangguh, penuh kasih, dan membawa perubahan nyata di manapun mereka berada.
