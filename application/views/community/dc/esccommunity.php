...
<style>
   ...
   * {
    ...
    .hero-bg {
      ...
      width: 70%;
      height: 100%;
      background-image: url('<?php echo base_url('assets/gambar/dc1.jpeg'); ?>');
      background-size: cover;
      background-position: center;
      z-index: 1;
      left: 15%;
...
<body>
 ...
 <!-- Konten -->
    ...
    <div class="section-image">
      <img src="<?php echo base_url('assets/gambar/dc1.jpeg'); ?>" alt="Small Groups">
    </div>
  </section>
    ...
    <div class="section light dedication">
     ...
     <section class="hero-section">
        ...
        <div class="hero-content">
          ...
          <p>
            <a href="<?php echo base_url('assets/gambar/formulir.pdf'); ?>" class="download-btn hero-btn"  style="margin-left: 0px;" download>
