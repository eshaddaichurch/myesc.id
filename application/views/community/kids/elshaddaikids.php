...
<body>
  ...
  <section class="section-container" id="small-groups" data-aos="fade-up">
    ...
    <div class="section-image">
      ...
      <img src="<?php echo base_url('assets/gambar/kids1.JPG'); ?>" alt="Small Groups">
    </div>
  </section>
  ...
  <!-- Section: Child Dedication -->
    ...
    <section class="early-years">
        ...
        <div class="image">
            ...
            <img src="<?php echo base_url('assets/gambar/kids6.JPG'); ?>" alt="Small Groups">
        </div>
    </section>
    ...
    <section class="kindy-section">
        <div class="kindy-image">
            ...
            <img src="<?php echo base_url('assets/gambar/kids5.jpg'); ?>" alt="Small Groups">
        </div>
      ...
      <section class="shining-years">
        ...
        <div class="image">
            ...
            <img src="<?php echo base_url('assets/gambar/kids7.jpg'); ?>" alt="Small Groups">
        </div>
    </section>
     ...
     <section class="events-calendar">
        ...
        <div class="events-list">
          <div>
            ...
            <img src="<?php echo base_url('assets/gambar/KS1.png'); ?>" alt="Small Groups">
            <p class="event-date-range"></p>
           
          </div>
          <div>
            <!--<img src="assets/gambar/KS2.png" alt="">-->
            <img src="<?php echo base_url('assets/gambar/KS2.png'); ?>" alt="Small Groups">
            <p class="event-date"></p>
           
          </div>
          <div>
            <!--<img src="assets/gambar/KS3.png" alt="">-->
            <img src="<?php echo base_url('assets/gambar/KS3.png'); ?>" alt="Small Groups">
            <p class="event-date"></p>
