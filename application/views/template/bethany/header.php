  ...
  <!-- datatables -->
  <link href="<?php echo (base_url("myesc.id/admin/assets/")) ?>datatables2/css/jquery.dataTables.min.css" rel="stylesheet">

  <!-- jquery-confirm -->
  <link rel="stylesheet" href="<?php echo (base_url("myesc.id/admin/assets/")) ?>jquery-confirm/css/jquery-confirm.min.css">

  <!-- jquery-ui -->
  <link rel="stylesheet" href="<?php echo (base_url("myesc.id/admin/assets/")) ?>jquery-ui/themes/base/jquery-ui.css">
  ...
  <link href="<?php echo (base_url()) ?>myesc.id/admin/assets/googleapis/googleapis.css" rel="stylesheet">
