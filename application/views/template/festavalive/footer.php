  ...
  <div class="esc-footer-body" style="display:grid; grid-template-columns:2fr 1fr 1fr; border-bottom:1px solid #1a1a1a;">
    ...
    <div style="padding:2.5rem 3rem; border-right:1px solid #1a1a1a;">
      ...
      <div style="display:flex; align-items:flex-start; gap:10px; margin-bottom:1.75rem;">
        ...
        <p style="font-size:13px; color:#666; margin:0; line-height:1.8;">Jl. Prof. M. Yamin No.1 A<br>Pontianak, Kalimantan Barat</p>
      </div>

      <a href="<?php echo site_url('') ?>/ourlocation/index/V05TSFJlBWcLYQ~~"
         style="display:inline-flex; align-items:center; gap:7px; font-size:12px; color:#555; border:1px solid #222; padding:7px 16px; text-decoration:none; letter-spacing:0.04em;">
    ...
    <div style="padding:2.5rem 2rem; border-right:1px solid #1a1a1a;">
      <p style="font-size:10px; letter-spacing:0.14em; text-transform:uppercase; color:#444; margin:0 0 1.25rem; font-weight:500;">Ikuti Kami</p>
