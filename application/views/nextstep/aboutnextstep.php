   ...
   <!-- Konten -->
    ...
    <section class="musik-section">
        ...
        <div class="musik-card">
             ...
             <img src="<?php echo base_url('assets/gambar/fc1.png'); ?>" alt="Deskripsi gambar">
        ...
        <div class="musik-card">
            <img src="<?php echo base_url('assets/gambar/fc2.png'); ?>" alt="Deskripsi gambar">
        ...
        <div class="musik-card">
            <img src="<?php echo base_url('assets/gambar/fc3.png'); ?>" alt="Deskripsi gambar">
        ...
        <div class="musik-card">
            <img src="<?php echo base_url('assets/gambar/mc.png'); ?>" alt="Deskripsi gambar">
        ...
        <div class="musik-card">
            <img src="<?php echo base_url('assets/gambar/vc.png'); ?>" alt="Deskripsi gambar">
        ...
        <div class="musik-card">
            <img src="<?php echo base_url('assets/gambar/gd1.png'); ?>" alt="Deskripsi gambar">
            <h3>GRADE 1</h3>
            <!-- <p>Hidup bersama kebenaran alkitabiah yang disesuaikan dengan anak-anak melalui nyanyian.</p> -->
        ...
        <div class="musik-card">
            <img src="<?php echo base_url('assets/gambar/gd2.png'); ?>" alt="Deskripsi gambar">
            <h3>GRADE 2</h3>
            <!-- <p>Hidup bersama kebenaran alkitabiah yang disesuaikan dengan anak-anak melalui nyanyian.</p> -->
        ...
        <div class="musik-card">
            <img src="<?php echo base_url('assets/gambar/gd3.png'); ?>" alt="Deskripsi gambar">
            <h3>GRADE 3</h3>
            <!-- <p>Hidup bersama kebenaran alkitabiah yang disesuaikan dengan anak-anak melalui nyanyian.</p> -->
        ...
        <div class="musik-card">
            <img src="<?php echo base_url('assets/gambar/mc1.png'); ?>" alt="Deskripsi gambar">
