  ...
  <main>
    ...
    <section class="equip-hero">
      <div class="container">
        ...
        <h1>Grade 2</h1>
        <p class="subtitle">Grade 2 The Power adalah kelas pengajaran lanjutan yang dirancang untuk membantu peserta mengenal lebih dalam tentang Roh Kudus, pribadi-Nya, dan peran-Nya dalam kehidupan orang percaya. 
          Melalui kelas ini, peserta akan mempelajari doktrin tentang Roh Kudus serta karya, karunia, dan buah Roh yang memampukan orang percaya menjalani hidup yang penuh kuasa dan kebenaran.</p>
      </div>
