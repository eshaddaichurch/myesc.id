...
class App extends CI_Model
{
	...
	// FITUR BARU: kirim email notifikasi ke admin (dipakai untuk notifikasi
	// booking ruangan). Dipisah dari sendEmailNextStep supaya tidak pakai
	// akun SMTP nextstep@myesc.id yang sudah punya keperluan sendiri.
	public function sendEmailAdmin($email, $subject, $textemail)
	{
		$this->load->library('email');
