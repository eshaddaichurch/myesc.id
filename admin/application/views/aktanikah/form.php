         ...
         <div class="col-md-12">
           <div class="card" id="cardcontent">
             <div class="card-body">
               ...
               <h3 class="text-gray">Data Akta Nikah</h3>
               <hr>
               ...
               <div class="form-group row">
                 <label for="" class="col-md-3 col-form-label">Jenis Akta</label>
                 <div class="col-md-9">
                   <div class="form-check form-check-inline">
                     <input class="form-check-input" type="radio" name="jenisakta" id="jenisakta1" value="Diberkati" checked="">
                     <label class="form-check-label" for="jenisakta1">Diberkati</label>
                   </div>
                   <div class="form-check form-check-inline">
                     <input class="form-check-input" type="radio" name="jenisakta" id="jenisakta2" value="Diteguhkan">
                     <label class="form-check-label" for="jenisakta2">Diteguhkan</label>
                   </div>
                 </div>
               </div>
     ...
     if (idakta != "") {
       ...
       $.ajax({
         ...
         .done(function(result) {
           ...
           if (result.jenisakta == 'Diberkati') {
             $('#jenisakta1').attr('checked', true);
           } else {
             $('#jenisakta2').attr('checked', true);
           }
         });
