...
<table cellpadding="5">
  <tbody>
    ...
    . $rowInfoGereja->namagereja . '</span><br>
        <span style="font-size:12px;">'
    . $rowInfoGereja->alamatgereja . '</span><br>
        <span style="font-size:12px;">Email: '
    . $rowInfoGereja->emailgereja . '</span>
      </td>
    </tr>
  </tbody>
</table>';
...
// ── JUDUL ──────────────────────────────────────────────────
$judul = '<h3 style="text-align:center;">
    LAPORAN ANGGOTA DISCIPLES COMMUNITY
</h3>';
...
if ($rsDc->num_rows() > 0) {
    ...
    foreach ($rsDc->result() as $rowDc) {
        ...
        // Ambil semua anggota
        $rsAnggota = $this->Dashboarddc_model->getAnggotaPerDc($rowDc->iddc);
        ...
        <table border="1" cellpadding="4">
          <thead>
            <tr style="font-size:10px; font-weight:bold; background-color:#bdc3c7;">
              ...
              <th width="58%" style="text-align:center;">Nama Anggota</th>
        ...
        if ($jumlahAnggota > 0) {
            ...
            foreach ($rsAnggota->result() as $rowAnggota) {
                ...
                <tr style="font-size:10px; ' . $bgBaris . '">
                  ...
                  <td width="58%" style="text-align:left; padding-left:5px;">
